...
export default function UnidadesProdutosPage() {
  return (
    <div className="space-y-4 max-w-full overflow-hidden">
      <div className="flex justify-end text-[11px] text-muted-foreground uppercase tracking-wider mb-2">
        ...
        <span className="mx-2">-</span>
        <span className="font-semibold text-foreground">Unidades de Produtos</span>
      </div>

      <div className="border-b pb-2 mb-4">
        <h1 className="text-xl font-headline font-bold text-foreground flex items-center gap-2">
          <Scale className="h-5 w-5 text-sidebar-foreground" /> Unidades de Medida
        </h1>
      </div>
      ...
      <div className="text-center py-20 border rounded-sm bg-gray-50">
        <p className="text-muted-foreground">Nenhuma unidade cadastrada (ex: UN, KG, CX).</p>
      </div>
    </div>
  )
}
