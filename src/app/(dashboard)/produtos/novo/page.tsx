...
export default function NovoProdutoPage() {
  ...
  const valorVenda = useMemo(() => {
    return custoFinal * (1 + (Number(form.lucroUtilizado) / 100))
  }, [custoFinal, form.lucroUtilizado])
        ...
        <div className="mt-6 bg-card border rounded-xl p-6 shadow-sm min-h-[500px]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="p-6 rounded-xl border bg-muted/20 space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="pt-4 mt-4 border-t flex justify-between items-center text-xl font-bold">
                    <span>Valor de Venda Final:</span>
                    <span className="text-primary">R$ {valorVenda.toFixed(2)}</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <TabsContent value="estoque" className="m-0 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="lg:col-span-4 p-6 border rounded-xl mt-4">
                <h3 className="font-semibold mb-4">Configuração de Grade / Variação</h3>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input placeholder="Ex: M, 42, Único" value={form.tamanho} onChange={(e) => handleFieldChange("tamanho", e.target.value)} />
                  </div>
                  <div className="space-y-2">
                    <Label>Cor Padrão</Label>
                    <Input placeholder="Ex: Azul, Preto" value={form.cor} onChange={(e) => handleFieldChange("cor", e.target.value)} />
                  </div>
                </div>
              </div>
            </div>
